...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DashBordController>(builder: (_) {
      return dashBordController.userDetailsModel == null || dashBordController.userDetailsModel!.data == null 
          ? Center(
              ...
              body: SafeArea(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        dashBordController.userDetailsModel!.data!.profilePic !=
                                ''
                            ? CircleAvatar(
                                radius: 50,
                            ...
                            : SvgPicture.asset('asset/icons/User Photo.svg'),
                        SizedBox(
                          width: 20,
                        ),
                        Text(
                            ...
                            children: [
                              TextSpan(
                                  text: dashBordController
                                              .counterCallingModel !=
                                          null 
                                      ? dashBordController.counterCallingModel!
                                              .data![0].counterNo! +
                                          "\n"
                                      : "",
                                  style: TextStyle(
                          ...
                          TextSpan(
                            children: [
                              TextSpan(
                                  text: dashBordController
                                              .counterCallingModel !=
                                          null && dashBordController
                                              .counterCallingModel!.data != null
                                      ? dashBordController.counterCallingModel!
                                              .data![1].counterNo! +
                                          "\n"
                                      : '',
